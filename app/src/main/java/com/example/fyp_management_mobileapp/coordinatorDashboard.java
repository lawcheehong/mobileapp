...
public class coordinatorDashboard extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    private void findViews() {
        ...
        bottomNavigationView.getMenu().findItem(R.id.coordinatorhome).setChecked(true);
    ...
    private void setListeners() {
        ...
        titleSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadTitleAbstract.class);
            startActivity(intent);
        });

        proposalSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadProposal.class);
            startActivity(intent);
        });

        thesisSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadThesisDraft.class);
            startActivity(intent);
        });

        proposalSlideSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadProposalSlide.class);
            startActivity(intent);
        });

        finalPresentationSlideSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadFinalSlide.class);
            startActivity(intent);
        });

        posterSubmissionlist.setOnClickListener(view -> {
            Intent intent = new Intent(coordinatorDashboard.this,supervisorViewAndDownloadPoster.class);
            startActivity(intent);
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.coordinatorviewscore){
            Intent intent = new Intent(coordinatorDashboard.this,coordinatorViewScore.class);
            startActivity(intent);
